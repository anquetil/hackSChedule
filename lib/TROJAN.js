          ...
          for(var key in courseHandler){
            ...
            for(var sectionKey in handler){
              ...
              object[courseID].SectionData[sectionData.id] = {
                ...
                day: !(typeof sectionData.day === 'object') ? [sectionData.day] || "" : sectionData.day || "",
                start_time: !(typeof sectionData.start_time === 'object') ? [sectionData.start_time] || "" : sectionData.start_time || "",
                end_time: !(typeof sectionData.end_time === 'object') ? [sectionData.end_time] || "" : sectionData.end_time || "",
                location: !(typeof sectionData.location === 'object') ? [sectionData.location] || "" : sectionData.location || "",
